...
Puts a Promptbox icon on your Desktop that launches with `pythonw`, so no console
window flashes up. The icon is generated by `assets/make_icon.py` if you want to
change it.
